...
const CsvUploadComponent: React.FC<CsvUploadComponentProps> = ({ onDataParsed, isProcessing }) => {
        ...
        complete: (results) => {
          ...
          data.forEach((row, index) => {
            try {
              ...
              const customerName = row.customerName || row.customer_name || row['Customer Name'] || row.name || row.Name || '';
