...
import { Upload, FileText, Download, Loader2, CheckCircle, AlertCircle, Building2 } from 'lucide-react';
      ...
      <div className="text-center space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-lg text-muted-foreground">
            Welcome Lisa! This tool will help you automatically split PDFs and name files by customer account information.
          </p>
      ...
      <footer className="mt-12 border-t bg-muted/30">
        <div className="max-w-4xl mx-auto p-6 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-2">
            Designed for efficient bill statement processing and customer account management
          </p>
        </div>
      </footer>
    </div>
